...
public class MenuDrink extends AppCompatActivity implements MhsAdapter.OnItemClickListener {
    ...
    TextView minuman, makanan, coffee, tea, txt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                Toast.makeText(MenuDrink.this, "Refreshing...", Toast.LENGTH_SHORT).show();
                callVolley();
        ...
        makanan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent loginIntent = new Intent(MenuDrink.this, MenuFood.class);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.home:
                        startActivity(new Intent(MenuDrink.this, Home.class));
                        return true;
                    case R.id.dashbord:
                        ...
                        return true;
                    case R.id.users:
                        startActivity(new Intent(MenuDrink.this, Order.class));
                        return true;
                    case R.id.user:
                        return true;
                    case R.id.profile:
    ...
    private void showConfirmationDialog(final String itemName, final String itemPrice, final String itemImage) {
        if (isItemInPreferences(itemName)) {
            new SweetAlertDialog(MenuDrink.this, SweetAlertDialog.ERROR_TYPE)
                    .setTitleText("Error")
            ...
            if (itemName.equals("Choco Sundae") || itemName.equals("Blueberry Milkshake") || itemName.equals("Red Velvet Vanilla")) {
                ...
                final SweetAlertDialog confirmationDialog = new SweetAlertDialog(MenuDrink.this, SweetAlertDialog.WARNING_TYPE)
                        ...
                        .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                            ...
                            public void onClick(final SweetAlertDialog sweetAlertDialog) {
                                ...
                                final SweetAlertDialog loadingDialog = new SweetAlertDialog(MenuDrink.this, SweetAlertDialog.PROGRESS_TYPE);
                                ...
                                new Handler().postDelayed(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        new SweetAlertDialog(MenuDrink.this, SweetAlertDialog.SUCCESS_TYPE)
                                                .setTitleText(itemName + " dimasukkan ke dalam keranjang!")
                                                .setContentText("Ingin order yang lain?")
                                                .show();
                                        CartManager.initializeCart(MenuDrink.this);
                                        CartManager.addToCart(new CartItem(itemName, Integer.parseInt(itemPrice), 1, itemImage), MenuDrink.this);
    ...
    private void callVolley() {
        ...
        JsonArrayRequest jArr = new JsonArrayRequest(konfigurasi.URLTAMPIL, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        if (obj.getString("tipe").equals("Drink")) {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(MenuDrink.this, "Gagal koneksi ke server, cek setingan koneksi anda", Toast.LENGTH_LONG).show();
            }
        });
